...
$BigImageMaxSize 		= 3000; //Image Maximum height or width
$ThumbPrefix			= "thumb_"; //Normal thumb Prefix
$DestinationDirectory	= 'uploads/'.$session_id.'/'; //Upload Directory ends with / (slash)
$Quality 				= 90;
...
if (is_array($ImageName)) 
{
	...
	for ($i=0; $i < $c; $i++)
	{
		...
		else
		{
			...
			$DestRandImageName 			= $DestinationDirectory.$NewImageName.'.'.$ImageExt; //Name for Big Image
