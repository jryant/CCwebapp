...
<form class="qlform" name="ql2" action="index.php?page=quicklook&step=3" method="post">
	...
	<ul class="col1">
		...
		<li><label for="s_salt_exp_notes">More information:</label><textarea cols="30" rows="4" name="s_salt_exp_notes" class="required"><?php echo $_SESSION['s_salt_exp_notes']; ?></textarea></li>
		...
		<li><label for="s_year_notes">More information:</label><textarea cols="30" rows="4" name="s_year_notes" class="required"><?php echo $_SESSION['s_year_notes']; ?></textarea></li>
		<li><label for="s_address">Address:</label><textarea cols="30" rows="4" name="s_address" class="required"><?php echo $_SESSION['s_address']; ?></textarea></li>
	</ul>
	<ul class="col2">
		...
		<li><label for="s_other_probs">Any other problems with the structure or in the area?</label><textarea cols="30" rows="4" name="s_other_probs" class="required"><?php echo $_SESSION['s_other_probs']; ?></textarea></li>
